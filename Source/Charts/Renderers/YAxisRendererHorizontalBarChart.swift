...
>>>>>>> original-master
    ...
    /// draws the x-name
    open override func drawNameYAxis (
        context: CGContext,
        nameRect: CGRect)
    {
        guard
        ...
        let labelAttrs = [NSAttributedString.Key.font: yAxis.nameAxisFont,
                          NSAttributedString.Key.foregroundColor: yAxis.nameAxisTextColor,
